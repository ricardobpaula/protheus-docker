...
/bin/sed 's/{{DBACCESS_SERVER}}/'"${DBACCESS_SERVER}"'/'      -i /totvs12/bin/appserver/appserver.ini
/bin/sed 's/{{DBACCESS_ALIAS}}/'"${DBACCESS_ALIAS}"'/'        -i /totvs12/bin/appserver/appserver.ini
/bin/sed 's/{{DBACCESS_PORT}}/'"${DBACCESS_PORT}"'/'        -i /totvs12/bin/appserver/appserver.ini
...
exec "/totvs12/bin/appserver/appsrvlinux" && tail -f -n 1 "console.log"